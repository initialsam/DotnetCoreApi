...
namespace DotnetCoreApi.Migrations
{
    ...
    [Migration("20200812130840_Create_spDepartment_Delete")]
    partial class Create_spDepartment_Delete
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DotnetCoreApi.Models.Course", b =>
                {
            ...
            modelBuilder.Entity("DotnetCoreApi.Models.CourseInstructor", b =>
                {
                    b.Property<int>("CourseId")
                        .HasColumnName("CourseID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DotnetCoreApi.Models.Department", b =>
                {
                    b.Property<int>("DepartmentId")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("DepartmentID")
            ...
            modelBuilder.Entity("DotnetCoreApi.Models.Enrollment", b =>
                {
            ...
            modelBuilder.Entity("DotnetCoreApi.Models.OfficeAssignment", b =>
                {
                    b.Property<int>("InstructorId")
                        .HasColumnName("InstructorID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DotnetCoreApi.Models.Person", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("ID")
            ...
            modelBuilder.Entity("DotnetCoreApi.Models.Course", b =>
                {
                    b.HasOne("DotnetCoreApi.Models.Department", "Department")
                        .WithMany("Course")
            ...
            modelBuilder.Entity("DotnetCoreApi.Models.CourseInstructor", b =>
                {
                    b.HasOne("DotnetCoreApi.Models.Course", "Course")
                    ...
                    b.HasOne("DotnetCoreApi.Models.Person", "Instructor")
                        .WithMany("CourseInstructor")
            ...
            modelBuilder.Entity("DotnetCoreApi.Models.Enrollment", b =>
                {
                    ...
                    b.HasOne("DotnetCoreApi.Models.Person", "Student")
                        .WithMany("Enrollment")
            ...
            modelBuilder.Entity("DotnetCoreApi.Models.OfficeAssignment", b =>
                {
                    b.HasOne("DotnetCoreApi.Models.Person", "Instructor")
                        ...
                        .HasForeignKey("DotnetCoreApi.Models.OfficeAssignment", "InstructorId")
